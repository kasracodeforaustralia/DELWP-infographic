$(window).scroll(function(){
	...
	var topPerc     = topPercfunc(); 
       ...
       /*if (topPerc >= 93.6){
 			$(".holder", '#dot-2', '#dot-3', '#dot-4', '#dot-5', '#dot-6', '#dot-7', '#dot-8', '#dot-9', '#dot-10', '#dot-11', '#dot-12', '#dot-13', '#dot-14', '#dot-15', '#dot-16', '#dot-17', '#dot-18', '#dot-19', '#dot-20', '#dot-21', '#dot-22', '#dot-23', '#dot-24', '#dot-25').hide();
       }else */if ( 93.0 <= topPerc &&  topPerc < 93.6 ){
        ...
        } else if ( 91.2 <= topPerc &&  topPerc < 91.8 ){
            $('#dot-1').css("display", 'block');
        ...
        } else if ( 58.0 <= topPerc &&  topPerc < 58.8 ){
